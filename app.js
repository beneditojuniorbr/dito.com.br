    ...
    app.renderMyProducts = function() {
        ...
        list.innerHTML = myP.map(p => `
            <div style="background:#fff; border:1px solid #eee; border-radius:24px; padding:16px; display:flex; align-items:center; gap:16px; margin-bottom: 12px; box-shadow: 0 4px 20px rgba(0,0,0,0.02);">
                ...
                <div style="display:flex; gap:8px;">
                    <button onclick="app.copyToClipboard('https://www.ditoapp.com.br/checkout/${p.id}', 'Link de Checkout copiado!', this)" title="Copiar Checkout" style="width:40px; height:40px; background:#f0f9ff; color:#0284c7; border:none; border-radius:50%; cursor:pointer; display: flex; align-items: center; justify-content: center; transition: 0.2s;" onmouseover="this.style.background='#e0f2fe'" onmouseout="this.style.background='#f0f9ff'"><i data-lucide="link" style="width:18px;"></i></button>
